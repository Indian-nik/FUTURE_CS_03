...
### 🔐 Server Start
![alt text](Screenshot1_ServerStart-1-1-1.png)

### 🏠 Homepage
![alt text](Screenshot2_homepage-1.png)

### ✅ Upload Success
![alt text](<Screenshot3_upload encrypt file-1.png>)

### 📥 File Download
![alt text](Screenshot4_download-1.png)

###  Decryption 
![alt text](Screenshot5_decryption-1.png)

### 🗑️ Decryption_success
![alt text](Screenshot6_decryption_success-1.png)
